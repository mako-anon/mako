...
############################################
def train_run_for_each_model(model_architecture, model_hyperpara, train_hyperpara, dataset, data_type, mat_file_name, classification_prob, saved_result=None, useGPU=False, GPU_device=0, doLifelong=False, saveParam=False, saveParamDir=None, saveGraph=False, tfInitParamPath=None, task_order=None, debug_data_group=-1):
